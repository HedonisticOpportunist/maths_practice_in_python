...
def find_nth_term_for_an_arithmetic_sequence(first_term: int, common_difference: int, requested_term: int) -> int:
    """
    Find the nth term in an arthimetic sequence
    :param first_term:
...
def find_sum_of_arthimetic_sequence(requested_terms: int, first_term: int, common_difference: int) -> int:
    """
    Finds the sum of an arthimetic sequence
    :param requested_terms:
    :param first_term:
    :param common_difference:
    :return: the sum of an arthimetic sequence
    """
